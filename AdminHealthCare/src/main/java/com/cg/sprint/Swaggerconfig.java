...
public class Swaggerconfig {
	...
	return new ApiInfoBuilder().title("Capgemini").description("API reference guide for developers").termsOfServiceUrl("https://www....../").contact("Batra, Yatin").version("1.0").build();	
	}
}
